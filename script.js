...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa fa-hand-peace-o", id: "weather-section", scrollable: false, title: "Hey! How's it goin'? " }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
            desc: "A tale of guardians watching over the vast universe.",
            id: 1,
            ...
            desc: "These Blue-skinned creatures with white hats dig hole to disrupt other animals.",
            id: 2,
            ...
            desc: "A boy with a large dent in his hand tries to get revenge on the man who caused this.",
            id: 3,
            ...
            desc: "A long drawn out story of god fighting over space. For them a whole universe was just a single dice.",
            id: 4,
...
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                desc: "Outrun a Security guard and his dog who found you spray painting on random Trains",
                id: 2,
                icon: "fa-solid fa-skating",
                image: "https://images.unsplash.com/photo-1584362119936-5707532714bd?q=80&w=1587&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                title: "Surf People"
            }, {
                desc: "Do tasks randomly assigned and vote out the impostor.",
                id: 3,
                icon: "fa-solid fa-coffee-bean",
                image: "https://images.unsplash.com/photo-1580843411760-ea295173bfd0?q=80&w=1665&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                title: "Suspicious Beans"
            }, {
                desc: "The Earth is Dying out so some people sent onto a journey through a wormhole, will they come back?.",
                id: 4,
                icon: "fa-solid fa-starship-freighter",
                image: "https://images.unsplash.com/photo-1636828982375-a4ec8b809e5e?q=80&w=1587&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
